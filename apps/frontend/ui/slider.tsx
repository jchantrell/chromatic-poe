...
const SliderThumb = <T extends ValidComponent = "span">(
  ...
  return (
    <SliderPrimitive.Thumb
      class={cn(
        "top-[-6px] block size-4 rounded-full border-2 border-primary bg-primary-foreground ring-offset-background transition-colors focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 cursor-pointer",
        local.class,
      )}
      {...others}
    >
