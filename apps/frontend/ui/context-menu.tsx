  ...
  return (
    <ContextMenuPrimitive.Portal>
      <ContextMenuPrimitive.Content
        class={cn(
          "z-50 min-w-32 origin-(--kb-menu-content-transform-origin) overflow-hidden rounded-md border bg-primary-foreground p-1 text-popover-foreground shadow-md animate-in",
          local.class,
        )}
        {...others}
      />
