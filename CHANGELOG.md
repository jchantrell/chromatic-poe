...
## [0.9.0](https://github.com/jchantrell/chromatic-poe/compare/chromatic-poe-v0.8.1...chromatic-poe-v0.9.0) (2026-01-06)


### Features

* allow importable filters list to toggle between versions ([8f3a984](https://github.com/jchantrell/chromatic-poe/commit/8f3a984a829d86ca32fb09be6fd967ced6bde1da))
* cloudflare worker cors proxy ([3ae59ad](https://github.com/jchantrell/chromatic-poe/commit/3ae59ad65bd63ff4e6cc38f8a952a58b06922df1))
...
* enchant mod support ([4fc846b](https://github.com/jchantrell/chromatic-poe/commit/4fc846b6493b00b7db734f46ae6827947140e833))
...
* increase fuzzy search accuracy for rules ([e6963ee](https://github.com/jchantrell/chromatic-poe/commit/e6963eeb5fb611202fa576ed5989d393d8562cfe))
...
* more granular app init progress bar ([43a970c](https://github.com/jchantrell/chromatic-poe/commit/43a970cea98da0538acf70e76ab1b8bdd92efc4f))
...
* more improvements to rule editor layout ([729c713](https://github.com/jchantrell/chromatic-poe/commit/729c713e780f78e7bb6f3cc921008c3635ac4ada))
* rule should only be sticky if it's expanded ([88c368b](https://github.com/jchantrell/chromatic-poe/commit/88c368ba41a00688cbebf8b10253d9efb9642b6d))
...
* undo/redo buttons in app bar ([7e54515](https://github.com/jchantrell/chromatic-poe/commit/7e5451527e6165db2982112b6a4f634623a1313a))
...
* virtualised scrolling for filter preview ([cf28a1f](https://github.com/jchantrell/chromatic-poe/commit/cf28a1f1002a8c4233a5712ece93f8e9a89f7d35))
...
* add minor offset to rule list to prevent scrollbar ([a4d65bc](https://github.com/jchantrell/chromatic-poe/commit/a4d65bc99d427f53537cfb0bcc127fe74a18f5fe))
* add proxy urls in env files ([dd1e1f5](https://github.com/jchantrell/chromatic-poe/commit/dd1e1f5f0fd32554e48441d4b1ee7db3adfb0f91))
...
* all browser warnings ([f3fb166](https://github.com/jchantrell/chromatic-poe/commit/f3fb166f9173868237c1df8b3fb1940da8d8a6e5))
...
* application init race condition ([4e7d277](https://github.com/jchantrell/chromatic-poe/commit/4e7d27779f6036a2eaf72e27f78844a9bdc75221))
* avoid caching in filter preview ([50417ab](https://github.com/jchantrell/chromatic-poe/commit/50417ab318144c3d53cab84649b9f46ac4c50461))
...
* dont spellcheck rule names ([f61d7e2](https://github.com/jchantrell/chromatic-poe/commit/f61d7e261f9f6bce31ea334babff7e16d54cd243))
...
* ensure all cfg files update on release ([135e27e](https://github.com/jchantrell/chromatic-poe/commit/135e27edbc7c2d456298d169da55b8ce56de17a9))
...
* imported sounds on desktop ([1e030a4](https://github.com/jchantrell/chromatic-poe/commit/1e030a4625d73807af8f0c4d8b74a55449ff58f5))
* layout issues for extremely long rule names ([425a400](https://github.com/jchantrell/chromatic-poe/commit/425a400096d6c484af8cd9e980727a2369be2d05))
* load filters together on page load ([7bad715](https://github.com/jchantrell/chromatic-poe/commit/7bad7150413fa68e4f89caf232a4aa07b805cc4b))
* make bool conditions serialise to correct syntax ([0e4c79a](https://github.com/jchantrell/chromatic-poe/commit/0e4c79adc94743eb5d1d77e1909d65aff4157951))
...
* more init race conditions ([b20db89](https://github.com/jchantrell/chromatic-poe/commit/b20db898cb46cfd749e7630a8ca04288b36699f8))
...
* redo action shouldnt reapply raw condition ([2a5c0e2](https://github.com/jchantrell/chromatic-poe/commit/2a5c0e256b1632a0711b5375c994643a4fe40a8c))
...
* rule menu entry flex behaviour ([fd8444c](https://github.com/jchantrell/chromatic-poe/commit/fd8444c72c0416c6fcfc80b53c5cb2034347cc50))
* rule menu entry preview should be clickable ([aa4c148](https://github.com/jchantrell/chromatic-poe/commit/aa4c148375979d4c9167267fbe97a88440ae5088))
* truncate progress toast msg ([c4dbc80](https://github.com/jchantrell/chromatic-poe/commit/c4dbc8082cc814a4170efa9d5a0c0aa4d275f310))
* type errors/warnings ([6ef3e99](https://github.com/jchantrell/chromatic-poe/commit/6ef3e99bfa4c868b8e2597b000f5f438c73fc027))
* use correct separator for OS when writing filter ([673c42c](https://github.com/jchantrell/chromatic-poe/commit/673c42c5b36ae56cf8537804c0437d0217b64a47))
...
* windows poe dir path ([7b3c867](https://github.com/jchantrell/chromatic-poe/commit/7b3c8670ee3b4b8c581c9321f121ba17db371ee8))
...
* only update rule map icon when it changes ([ab5dc98](https://github.com/jchantrell/chromatic-poe/commit/ab5dc98da66f49ece255547770504b4e8a1a195d))
